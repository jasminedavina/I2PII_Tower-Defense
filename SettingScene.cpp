...
void SettingScene::Initialize() {
    ...
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", w - 450, h-150, 400, 100);
    btn->SetOnClickCallback(std::bind(&SettingScene::PlayOnClick, this, 1));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, w-250, h-100, 0, 0, 0, 255, 0.5, 0.5));
}
